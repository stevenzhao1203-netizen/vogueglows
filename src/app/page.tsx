...
export default function HomePage() {
  ...
  return <main>
    ...
    <section className="story-home-hero">
      ...
      <div><p>VogueGlows</p><h1>Notes on getting dressed, beauty, and packing well.</h1><span>I keep this journal for the pieces that make me stop and look twice, then check the fit, materials, ingredients, and small print before sharing them.</span><a href="#stories">Browse the current notes <ArrowRight size={16} /></a></div>
    </section>
