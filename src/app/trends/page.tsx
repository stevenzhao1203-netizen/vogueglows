...
export default function TrendsPage() {
  return <main>
    ...
    <section className="trends-index">
      <p>The Edit</p>
      <h1>A useful place to start before you buy.</h1>
      <span>Current shop guides built around fit, use, material, and the everyday details that are easy to overlook.</span>
