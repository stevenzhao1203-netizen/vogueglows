...
const pages: Record<string, { title: string; body: string[] }> = {
  about: { title: "About VogueGlows", body: ["VogueGlows is a journal for the decisions that sit between wanting something and bringing it home. The subjects are ordinary: a blazer that needs to work with the clothes already in a wardrobe, a travel case that keeps the small things together, or an appliance that needs to earn its counter space.", "The Journal is for the longer notes behind those decisions. The Edit is more direct: a place to compare fit, material, care, return terms, and the everyday details a product page can make easy to miss.", "A guide is not presented as a hands-on review. Product facts are checked against a manufacturer or retailer page, and an affiliate disclosure appears close to any qualifying link. The final details, including price and availability, always belong to the current listing."] },
